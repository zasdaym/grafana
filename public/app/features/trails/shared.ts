import { BusEventBase, BusEventWithPayload, PanelData } from '@grafana/data';
...
export class SelectedMetricQueryResultsEvent extends BusEventWithPayload<PanelData | undefined> {
